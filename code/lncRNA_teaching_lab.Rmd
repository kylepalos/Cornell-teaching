...
counts <- read.delim("~/light_counts.txt", check.names = FALSE, stringsAsFactors = FALSE)
...
download.file(metadata_link,
              "~/high_light_simple_metadata.txt")

metadata <- read.delim("~/high_light_simple_metadata.txt", stringsAsFactors = FALSE)
head(metadata)
...
>
> 3.  Can you identify any potential outliar samples or batch effects that might affect downstream analysis?
...
tf_list <- read.delim("~/Ath_TF_list.txt", stringsAsFactors = FALSE)
head(tf_list)
